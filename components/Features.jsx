...
const featuresData = [
    ...
    },
    {
        ...
        description: "Collaboration with your team in real-time.",
        highlights: [
            "Set due dates and reminders.",
            "Track progress ad milestones",
            "Easily sort tasks by priority"
            ...
            <div className="flex gap-16">
                ...
                >
                    <div className="relative w-full h-full">
                        <Image src={featuresData[imgIndex].imgSrc} fill alt="" className=" object-contain" />
                    </div>
                </motion.div>
                <div className="flex-1 flex flex-col gap-24">
                    {featuresData.map((item, itemIndex) => {
                        ...
                        viewport={{amount: "all"}} 
                        key={itemIndex} 
                        className="flex items-center h-auto w-full xl:h-[460px]"
                        >
